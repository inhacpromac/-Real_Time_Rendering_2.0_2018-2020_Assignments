...
void display(void)
{
	...
	if (passedDigit == 1)
	{
		...
		reactangleTexture[8] = 0.5f;
		reactangleTexture[9] = 0.5f;
		reactangleTexture[10] = 0.5f;
		reactangleTexture[11] = 1.0f;
	}
	else if (passedDigit == 2)
	{
		...
		reactangleTexture[6] = 0.0f;
		reactangleTexture[7] = 1.0f;
		reactangleTexture[8] = 1.0f;
		reactangleTexture[9] = 0.0f;
		reactangleTexture[10] = 1.0f;
		reactangleTexture[11] = 1.0f;
	}
	else if (passedDigit == 3)
	{
		...
		reactangleTexture[8] = 2.0f;
		reactangleTexture[9] = 0.0f;
		reactangleTexture[10] = 2.0f;
		reactangleTexture[11] = 2.0f;
	}
	...
	gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer_Texture,
		...
		NULL,
		&mappedSubresource);
	memcpy(mappedSubresource.pData, reactangleTexture, sizeof(reactangleTexture));
	gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertexBuffer_Texture, NULL);
