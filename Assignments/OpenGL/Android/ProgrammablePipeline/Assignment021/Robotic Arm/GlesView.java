package com.inhacpromac.robotic_arm;
...
public class GlesView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
	...
	private float angleShoulder = 0.0f;
	private float angleElbow = 0.0f;
    ...
    private void display() {
		...
		Matrix.rotateM(modelViewMatrix, 0, angleShoulder, 0.0f, 0.0f, 1.0f);
		Matrix.translateM(modelViewMatrix, 0, 1.0f, 0.0f, 0.0f);
		//temp = modelViewMatrix;
		Matrix.multiplyMM(temp, 0, modelViewMatrix, 0, test, 0);
		...
		Matrix.multiplyMM(modelViewMatrix, 0, temp, 0, test, 0);
		Matrix.translateM(modelViewMatrix, 0, 1.0f, 0.0f, 0.0f);
		Matrix.rotateM(modelViewMatrix, 0, angleElbow, 0.0f, 0.0f, 1.0f);
		Matrix.translateM(modelViewMatrix, 0, 1.0f, 0.0f, 0.0f);
		Matrix.scaleM(modelViewMatrix, 0, 2.0f, 0.5f, 1.0f);
