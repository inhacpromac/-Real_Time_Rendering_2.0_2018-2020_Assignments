...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	window=[[NSWindow alloc] initWithContentRect:win_rect
										...
										defer:NO];
	[window setTitle:@"macOS Window:SolarSystem"];
	[window center];
...
- (void)drawView
{
    ...
    //Do necessary Trasformation
    modelViewMatrix *= vmath::rotate((GLfloat)giYear, 0.0f, 1.0f, 0.0f);
    modelViewMatrix *= vmath::translate(2.0f, 0.0f, 0.0f);
    modelViewMatrix *= vmath::rotate((GLfloat)giDay, 0.0f, 1.0f, 0.0f);
