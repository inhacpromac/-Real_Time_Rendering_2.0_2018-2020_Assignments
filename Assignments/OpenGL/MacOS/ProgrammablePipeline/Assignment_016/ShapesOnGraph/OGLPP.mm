...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	window=[[NSWindow alloc] initWithContentRect:win_rect
										...
										defer:NO];
	[window setTitle:@"macOS Window:Perspective"];
	[window center];
...
@private
    ...
    /*int numberOfCircleLines;
    int numberOfCircleVertices;
    int numberOfTriangleVertices;
    int numberOfSquareVertices;
    int numberOfGraphVertices;
    float PI;
    int giNumberOfGraphLines;
    int giTotalNumberOfLines;*/
...
-(id)initWithFrame:(NSRect)frame;
{
	...
	if(self)
	{
		NSOpenGLPixelFormatAttribute attrs[]=
		{
            ...
            /*numberOfCircleLines = 5000;
            numberOfCircleVertices = 5000 * 2 * 3;
            numberOfTriangleVertices = 3 * 3;
            numberOfSquareVertices = 4 * 3;
            numberOfGraphVertices = 1024;
            PI = 3.14;
            giNumberOfGraphLines = 0;
            giTotalNumberOfLines = 0;*/
