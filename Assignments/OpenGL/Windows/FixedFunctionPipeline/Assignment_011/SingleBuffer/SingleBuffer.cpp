...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
		case VK_ESCAPE:
			MessageBox(hwnd, TEXT("This is Escape. 'ESC' Key Is Pressed..."), TEXT("My Messages"), MB_OK);
			DestroyWindow(hwnd);
			break;
		case 0x46:
			ToggleFullScreen();
			MessageBox(hwnd, TEXT("This is FullScreen. 'F' Key Is Pressed..."), TEXT("My Messages"), MB_OK);
			break;
		}
		break;
	case WM_CLOSE:
