...
int main(void)
{
	...
	// *** CALLING FUNCTION AddStructMembers() WHICH ACCEPTS THREE VARIABLES OF TYPE 'struct MyData' AS PARAMETERS 
	// AND ADDS UP THE RESPECTIVE MEMBERS AND RETURNS THE ANSWER IN ANOTHER struct OF SAME TYPE ***
